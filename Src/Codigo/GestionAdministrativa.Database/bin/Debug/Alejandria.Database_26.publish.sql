...
GO
ALTER TABLE [dbo].[Cobradores] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Cobradores] WITH CHECK CHECK CONSTRAINT [FK_Cobradores_OperadorAlta];

ALTER TABLE [dbo].[Cobradores] WITH CHECK CHECK CONSTRAINT [FK_Cobradores_OperadorModificacion];

ALTER TABLE [dbo].[Cobradores] WITH CHECK CHECK CONSTRAINT [FK_Cobradores_SucursalAlta];

ALTER TABLE [dbo].[Cobradores] WITH CHECK CHECK CONSTRAINT [FK_Cobradores_SucursalModificacion];
