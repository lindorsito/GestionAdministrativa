...
IF EXISTS (select top 1 1 from [dbo].[EstadosVenta])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping [dbo].[FK_EstadosVenta_OperadorAltaId]...';


GO
ALTER TABLE [dbo].[EstadosVenta] DROP CONSTRAINT [FK_EstadosVenta_OperadorAltaId];


GO
PRINT N'Dropping [dbo].[FK_EstadosVenta_SucursalAltaId]...';


GO
ALTER TABLE [dbo].[EstadosVenta] DROP CONSTRAINT [FK_EstadosVenta_SucursalAltaId];


GO
PRINT N'Altering [dbo].[EstadosVenta]...';


GO
ALTER TABLE [dbo].[EstadosVenta] ALTER COLUMN [OperadorAltaId] UNIQUEIDENTIFIER NOT NULL;

ALTER TABLE [dbo].[EstadosVenta] ALTER COLUMN [SucursalAltaId] INT NOT NULL;
