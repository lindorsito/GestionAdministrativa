...
ALTER TABLE [dbo].[Personal]  WITH NOCHECK ADD  CONSTRAINT [FK_Personal_Localidad] FOREIGN KEY([LocalidadId])
...
ALTER TABLE [dbo].[Personal]  WITH NOCHECK ADD  CONSTRAINT [FK_Personal_Provincia] FOREIGN KEY([ProvinciaId])
REFERENCES [dbo].[Provincias] ([Id])
GO

ALTER TABLE [dbo].[Personal] CHECK CONSTRAINT [FK_Personal_Provincia]
GO