...
using GestionAdministrativa.Data.Repository;
...
namespace GestionAdministrativa.Data.Helpers
{
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetGestionAdministrativaFactories()
        {
        ...
        {
            _repositoryFactories = GetGestionAdministrativaFactories();
        }
